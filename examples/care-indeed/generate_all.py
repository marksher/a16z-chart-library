...
# Add default to sys.path so care-indeed modules can resolve their data imports.
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    header h1 { font-size: 28px; font-weight: bold; color: #1F1C1B; margin-bottom: 6px; }
    header p  { font-size: 13px; color: #7A7470; font-style: italic; }
    ...
    .dl-btn:hover { background: #E05520; }

    /* ── Swatch ── */
    .swatch-section {
      margin-bottom: 56px; padding: 24px;
      background: #FFFAF7;
      border: 1px solid #D9D6D5; border-radius: 4px;
    }

    .swatch-section h2 {
      font-size: 14px; font-weight: bold; color: #1F1C1B;
    ...
    .swatch-group-label {
      font-size: 10px; font-weight: bold; color: #9E9691;
    ...
    .swatch-hex { font-size: 9px; color: #7A7470; font-family: monospace; }
    .swatch-name { font-size: 9px; color: #9E9691; }
    ...
    .code-snippet pre { margin: 0; overflow-x: auto; background: #FAFAF8; }

    .code-snippet code.hljs {
      font-size: 12px; line-height: 1.55;
      background: #FAFAF8; padding: 16px 20px;
    }
  </style>
</head>
<body>
  <header>
    <div class="header-row">
      ...
      <button class="dl-btn" onclick="dlPage('chart-library-care-indeed.html')">&#8595; Download HTML</button>
    </div>
  </header>
""" + swatch_section + "\n".join(sections) + """
