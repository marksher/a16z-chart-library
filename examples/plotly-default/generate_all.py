"""
Generate all.html — gallery of all chart types using the plotly-default theme (theme=None).
...
<body>
  <header>
    <div class="header-row">
      <div>
        <h1>Chart Library</h1>
        <p>All chart types — interactive Plotly / PNG export / SVG export. Theme: plotly-default.</p>
      </div>
      <button class="dl-btn" onclick="dlPage('chart-library-plotly-default.html')">&#8595; Download HTML</button>
    </div>
  </header>
""" + "\n".join(sections) + """
