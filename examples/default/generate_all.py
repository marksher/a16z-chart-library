"""
Generate all.html — gallery of all chart types using Plotly default theme (theme=None).
...
# Add a16z-news to sys.path so default modules can resolve their data imports.
...
<body>
  <header>
    <div class="header-row">
      <div>
        <h1>Chart Library</h1>
        <p>All chart types — interactive Plotly / PNG export / SVG export. Theme: default (Plotly defaults).</p>
      </div>
